                    ...
                    <div className="flex items-center justify-center space-x-6 md:order-2">
                        {facebookPage && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="outline-rose-600 hover:text-blue-600 dark:hover:text-blue-600"
                            >
                        ...
                        {twitterCompanyProfile && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="outline-rose-600 hover:text-blue-400 dark:hover:text-blue-400"
                            >
                        ...
                        {instagramBusinessProfile && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="outline-rose-600 hover:text-rose-600 dark:hover:text-rose-600"
                            >
