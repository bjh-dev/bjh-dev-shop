        ...
        <div className="light:bg-gray-200 py-16 lg:py-24">
            <div className="container lg:grid lg:grid-cols-3 lg:gap-x-8">
                    ...
                    <div className="flex flex-col space-y-4">
                        <div>
                            <h2 className="font-plantin text-5xl tracking-tight sm:text-6xl md:text-7xl lg:text-7xl xl:text-6xl">
                                Avoid{' '}
                                <span className="text-rose-600 underline decoration-gray-800 decoration-4 underline-offset-8">
                                    Costly
                                </span>{' '}
                                Mistakes
                            </h2>
                ...
                <div className="mt-12 lg:col-span-2 lg:mt-0">
                    <dl className="flex flex-col space-y-6 md:grid md:grid-cols-2 md:gap-x-6 md:gap-y-12 md:space-y-0 ">
                        {features.slice(0, -1).map(feature => (
                            <div key={feature._key}>
                                ...
                                <dd className="light:text-gray-500 ml-9 mt-2 text-sm dark:text-gray-300">
                                    <CustomPortableText
                    ...
                    {features.slice(-1).map(lastfeature => (
                        <dl
                            ...
                            className="relative col-span-2 mt-12 rounded-md border border-rose-600 px-6 py-4"
                        >
                            <dt>
